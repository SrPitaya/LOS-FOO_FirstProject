...
$query = "SELECT asignatura.nombre AS Materias, asignatura.cuatrimestre 
          FROM asignatura 
          ORDER BY asignatura.cuatrimestre, Materias 
          LIMIT $limit OFFSET $offset";
$result = mysqli_query($conn, $query);

// Consulta para obtener el total de registros
$totalQuery = "SELECT COUNT(*) as total FROM asignatura";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td class='p-4'>" . $row['Materias'] . "</td>";
    echo "<td class='p-4'>" . $row['cuatrimestre'] . "</td>";
    echo "</tr>";
}
